    ...
    return (
        <div className='grid md:grid-cols-2 lg:grid-cols-3 container mx-auto gap-4 md:my-14'>
            ...
            <div className='bg-slate-700 px-3 py-10 text-white font-medium text-lg rounded'>
                ...
                <p className='text-base'>
                    Context api works like a global variable.Through this api we can share data any of its under provider.
                    Context api is the alternative of prop drilling.To get rid of prop drilling context api were made.
                </p>
            </div>
            <div className='bg-slate-700 px-3 py-10 text-white font-medium text-lg rounded'>
                <h2 className='text-2xl my-5'>
